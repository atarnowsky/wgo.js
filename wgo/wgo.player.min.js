/*! MIT license, more info: wgo.waltheri.net */(function(b,p){var g=function(u){var a=new r(JSON.parse(JSON.stringify(u.getProperties()))),c;for(c in u.children)a.appendChild(g(u.children[c]));return a},f=function(u,a){var c;if(a[u]!==p)return a[u];for(var h in a.children)if(c=f(u,a.children[h]))return c;return!1},m=function(a,c){a.push(JSON.parse(JSON.stringify(c.getProperties())));if(1<c.children.length){for(var h=[],e=0;e<c.children.length;e++){var d=[];m(d,c.children[e]);h.push(d)}a.push(h)}else c.children.length&&m(a,c.children[0])},d=function(c,
a){for(var h=a,e,b=1;b<c.length;b++)if(c[b].constructor==Array)for(var k=0;k<c[b].length;k++)e=new r(c[b][k][0]),h.appendChild(e),d(c[b][k],e);else e=new r(c[b]),h.insertAfter(e),h=e},l=function(c){return"string"==typeof c?c.replace(/\\/g,"\\\\").replace(/]/g,"\\]"):c},a=function(c,a){return String.fromCharCode(97+c)+String.fromCharCode(97+a)},h=function(c,a,h){if(a.length){h.sgf+=c;for(var e in a)h.sgf+="["+a[e]+"]"}},k=function(c,e){if(c.move){var d="";c.move.pass||(d=a(c.move.x,c.move.y));e.sgf=
c.move.c==b.B?e.sgf+("B["+d+"]"):e.sgf+("W["+d+"]")}if(c.setup){var d=[],n=[],f=[],q;for(q in c.setup)c.setup[q].c==b.B?d.push(a(c.setup[q].x,c.setup[q].y)):c.setup[q].c==b.W?n.push(a(c.setup[q].x,c.setup[q].y)):f.push(a(c.setup[q].x,c.setup[q].y));h("AB",d,e);h("AW",n,e);h("AE",f,e)}if(c.markup){d={};for(q in c.markup)d[c.markup[q].type]=d[c.markup[q].type]||[],"LB"==c.markup[q].type?d.LB.push(a(c.markup[q].x,c.markup[q].y)+":"+l(c.markup[q].text)):d[c.markup[q].type].push(a(c.markup[q].x,c.markup[q].y));
for(var g in d)h(g,d[g],e)}q=c.getProperties();for(g in q)"object"!=typeof q[g]&&(e.sgf="turn"==g?e.sgf+("PL["+(q[g]==b.B?"B":"W")+"]"):"comment"==g?e.sgf+("C["+l(q[g])+"]"):e.sgf+(g+"["+l(q[g])+"]"));if(1==c.children.length)e.sgf+="\n;",k(c.children[0],e);else if(1<c.children.length)for(g in c.children)q=c.children[g],d=e,d.sgf+="(\n;",k(q,d),d.sgf+="\n)"},n=function(){this.size=19;this.info={};this.root=new r;this.propertyCount=this.nodeCount=0};n.prototype={constructor:n,clone:function(){var c=
new n;c.size=this.size;c.info=JSON.parse(JSON.stringify(this.info));c.root=g(this.root);c.nodeCount=this.nodeCount;c.propertyCount=this.propertyCount;return c},hasComments:function(){return!!f("comment",this.root)}};n.fromSgf=function(c){return b.SGF.parse(c)};n.fromJGO=function(c){c="string"==typeof c?JSON.parse(c):c;var a=new n;a.info=JSON.parse(JSON.stringify(c.info));a.size=c.size;a.nodeCount=c.nodeCount;a.propertyCount=c.propertyCount;a.root=new r(c.game[0]);d(c.game,a.root);return a};n.prototype.toSgf=
function(){var c={sgf:"(\n;"},a={},e;for(e in this.info)"black"==e?(this.info.black.name&&(a.PB=l(this.info.black.name)),this.info.black.rank&&(a.BR=l(this.info.black.rank)),this.info.black.team&&(a.BT=l(this.info.black.team))):"white"==e?(this.info.white.name&&(a.PW=l(this.info.white.name)),this.info.white.rank&&(a.WR=l(this.info.white.rank)),this.info.white.team&&(a.WT=l(this.info.white.team))):a[e]=l(this.info[e]);this.size&&(a.SZ=this.size);a.AP||(a.AP="WGo.js:2");a.FF||(a.FF="4");a.GM||(a.GM=
"1");a.CA||(a.CA="UTF-8");for(e in a)a[e]&&(c.sgf+=e+"["+a[e]+"]");k(this.root,c);c.sgf+=")";return c.sgf};n.prototype.toJGO=function(c){var a={};a.size=this.size;a.info=JSON.parse(JSON.stringify(this.info));a.nodeCount=this.nodeCount;a.propertyCount=this.propertyCount;a.game=[];m(a.game,this.root);return c?JSON.stringify(a):a};var e=function(c){var a;c.name?(a=b.filterHTML(c.name),c.rank&&(a+=" ("+b.filterHTML(c.rank)+")"),c.team&&(a+=", "+b.filterHTML(c.team))):(c.team&&(a=b.filterHTML(c.team)),
c.rank&&(a+=" ("+b.filterHTML(c.rank)+")"));return a};n.infoFormatters={black:e,white:e,TM:function(c){if(0==c)return b.t("none");var a,e=Math.floor(c/60);1==e?a="1 "+b.t("minute"):1<e&&(a=e+" "+b.t("minutes"));e=c%60;1==e?a+=" 1 "+b.t("second"):1<e&&(a+=" "+e+" "+b.t("seconds"));return a},RE:function(c){return'<a href="javascript: void(0)" onclick="this.parentNode.innerHTML = \''+b.filterHTML(c)+'\'" title="'+b.t("res-show-tip")+'">'+b.t("show")+"</a>"}};n.infoList="black white AN CP DT EV GN GC HA ON OT RE RO RU SO TM US PC KM".split(" ");
b.Kifu=n;var c=function(c,a,e){for(var h=0;h<c.length;h++)if(c[h].x==a.x&&c[h].y==a.y){c[h][e]=a[e];return}c.push(a)},q=function(c,a){if(c)for(var e=0;e<c.length;e++)if(c[e].x==a.x&&c[e].y==a.y){c.splice(e,1);break}},r=function(c,a){this.parent=a||null;this.children=[];if(c)for(var e in c)this[e]=c[e]};r.prototype={constructor:r,getChild:function(c){c=c||0;return this.children[c]?this.children[c]:null},addSetup:function(a){this.setup=this.setup||[];c(this.setup,a,"c");return this},removeSetup:function(c){q(this.setup,
...
65)+""+(19-a.move.y)}else this.message+="Move object doesn't contain arbitrary attributes.";if(c)switch(c){case 1:this.message+=", but these coordinates are not on board.";break;case 2:this.message+=", but there already is a stone.";break;case 3:this.message+=", but this move is a suicide.";break;case 4:this.message+=", but this position already occured."}else this.message+="."};x.prototype=Error();x.prototype.constructor=x;b.InvalidMoveError=x;b.i18n.en.show="show";b.i18n.en["res-show-tip"]="Click to show result."})(WGo);(function(b,p){b.SGF={};var g=function(a,d,b,e,c,l){d=l==d?"black":"white";b.info[d]=b.info[d]||{};b.info[d][a]=c[0]},f=b.SGF.properties={};f.B=f.W=function(a,d,l,e){d.move=!l[0]||19>=a.size&&"tt"==l[0]?{pass:!0,c:"B"==e?b.B:b.W}:{x:l[0].charCodeAt(0)-97,y:l[0].charCodeAt(1)-97,c:"B"==e?b.B:b.W}};f.AB=f.AW=function(a,d,l,e){for(var c in l)d.addSetup({x:l[c].charCodeAt(0)-97,y:l[c].charCodeAt(1)-97,c:"AB"==e?b.B:b.W})};f.AE=function(a,d,b){for(var e in b)d.addSetup({x:b[e].charCodeAt(0)-97,y:b[e].charCodeAt(1)-
...
this._wheel_listener)):this._wheel_listener&&!a&&(a=void 0!==document.onmousewheel?"mousewheel":"DOMMouseScroll",this.element.removeEventListener(a,this._wheel_listener),delete this._wheel_listener)},setCoordinates:function(a){!this.coordinates&&a?(this.board.setSection(-.5,-.5,-.5,-.5),this.board.addCustomObject(b.Board.coordinates)):this.coordinates&&!a&&(this.board.setSection(0,0,0,0),this.board.removeCustomObject(b.Board.coordinates));this.coordinates=a}};k["default"]={sgf:void 0,json:void 0,
sgfFile:void 0,move:void 0,board:{},enableWheel:!0,lockScroll:!0,enableKeys:!0,rememberPath:!0,kifuLoaded:void 0,update:void 0,frozen:void 0,unfrozen:void 0,allowIllegalMoves:!1,markLastMove:!0,displayVariations:!0};b.Player=k;var n={"about-text":"<h1>WGo.js Player 2.0</h1><p>WGo.js Player is extension of WGo.js, HTML5 library for purposes of game of go. It allows to replay go game records and it has many features like score counting. It is also designed to be easily extendable.</p><p>WGo.js is open source licensed under <a href='http://en.wikipedia.org/wiki/MIT_License' target='_blank'>MIT license</a>. You can use and modify any code from this project.</p><p>You can find more information at <a href='http://wgo.waltheri.net/player' target='_blank'>wgo.waltheri.net/player</a></p><p>Copyright &copy; 2013 Jan Prokop</p>",
black:"Black",white:"White",DT:"Date",KM:"Komi",HA:"Handicap",AN:"Annotations",CP:"Copyright",GC:"Game comments",GN:"Game name",ON:"Fuseki",OT:"Overtime",TM:"Basic time",RE:"Result",RO:"Round",RU:"Rules",US:"Recorder",PC:"Place",EV:"Event",SO:"Source",none:"none",bpass:"Black passed.",wpass:"White passed."},e;for(e in n)b.i18n.en[e]=n[e]})(WGo);(function(b){var p=0,g=function(d,b,a){var h={};h.element=document.createElement("div");h.element.className="wgo-player-"+d;h.wrapper=document.createElement("div");h.wrapper.className="wgo-player-"+d+"-wrapper";h.element.appendChild(h.wrapper);b.appendChild(h.element);a||(h.element.style.display="none");return h},f=function(d){var b;if(b=this.currentLayout.layout?this.currentLayout.layout[d]:this.currentLayout[d]){this.regions[d].element.style.display="block";b.constructor!=Array&&(b=[b]);for(var a in b)this.components[b[a]]||
(this.components[b[a]]=new m.component[b[a]](this)),this.components[b[a]].appendTo(this.regions[d].wrapper),this.components[b[a]]._detachFromPlayer=!1}else this.regions[d].element.style.display="none"},m=b.extendClass(b.Player,function(d,l){this.config=l;for(var a in m["default"])void 0===this.config[a]&&void 0!==m["default"][a]&&(this.config[a]=m["default"][a]);for(a in b.Player["default"])void 0===this.config[a]&&void 0!==b.Player["default"][a]&&(this.config[a]=b.Player["default"][a]);this.element=
...
function(a){f(a)}):a||this.info_overlay.addEventListener("click",function(a){this.hideMessage()}.bind(this));this.setFrozen(!0)};m.prototype.hideMessage=function(){this.element.removeChild(this.info_overlay);this.setFrozen(!1)};m.prototype.error=function(d){if(!b.ERROR_REPORT)throw d;switch(d.name){case "InvalidMoveError":this.showMessage("<h1>"+d.name+"</h1><p>"+d.message+'</p><p>If this message isn\'t correct, please report it by clicking <a href="#">here</a>, otherwise contact maintainer of this site.</p>');
...
d=parseInt(b.fontSize));if(!(d==b&&a.scrollHeight<=a.offsetHeight))if(a.scrollHeight>a.offsetHeight)for(d-=2;a.scrollHeight>a.offsetHeight&&1<d;)a.style.fontSize=d+"px",d-=2;else if(d<b){for(d+=2;a.scrollHeight<=a.offsetHeight&&d<=b;)a.style.fontSize=d+"px",d+=2;a.scrollHeight>a.offsetHeight&&(a.style.fontSize=d-4+"px")}},m=function(a){a.node.BL&&this.setPlayerTime("black",a.node.BL);a.node.WL&&this.setPlayerTime("white",a.node.WL);void 0!==a.position.capCount.black&&(this.black.info.caps.val.innerHTML=
a.position.capCount.black);void 0!==a.position.capCount.white&&(this.white.info.caps.val.innerHTML=a.position.capCount.white)},d=WGo.extendClass(WGo.BasicPlayer.component.Component,function(a){this["super"](a);this.element.className="wgo-infobox";b.call(this,"white");b.call(this,"black");this.element.appendChild(this.white.box);this.element.appendChild(this.black.box);a.addEventListener("kifuLoaded",g.bind(this));a.addEventListener("update",m.bind(this))});d.prototype.setPlayerTime=function(a,b){var d=
Math.round(b)%60;this[a].info.time.val.innerHTML=Math.floor(b/60)+":"+(10>d?"0"+d:d)};d.prototype.updateDimensions=function(){f(this.black.name);f(this.white.name)};var l=WGo.BasicPlayer.layouts;l.right_top.right.push("InfoBox");l.right.right.push("InfoBox");l.one_column.top.push("InfoBox");l.no_comment.top.push("InfoBox");WGo.i18n.en.rank="Rank";WGo.i18n.en.caps="Caps";WGo.i18n.en.time="Time";WGo.BasicPlayer.component.InfoBox=d})(WGo);(function(b,p){var g=function(a){var b,d;b=a.charCodeAt(0)-97;0>b&&(b+=32);7<b&&b--;d=a.charCodeAt(1)-48;2<a.length&&(d=10*d+(a.charCodeAt(2)-48));d=this.kifuReader.game.size-d;this._tmp_mark={type:"MA",x:b,y:d};this.board.addObject(this._tmp_mark)},f=function(){this.board.removeObject(this._tmp_mark);delete this._tmp_mark},m=function(a,b){for(var d in a)a[d].className&&"wgo-move-link"==a[d].className?(a[d].addEventListener("mouseover",g.bind(b,a[d].innerHTML)),a[d].addEventListener("mouseout",f.bind(b))):
a[d].childNodes&&a[d].childNodes.length&&m(a[d].childNodes,b)},d=function(a,d){var f='<div class="wgo-info-list">';d&&(f+='<div class="wgo-info-title">'+b.t("gameinfo")+"</div>");for(var g in a)f+='<div class="wgo-info-item"><span class="wgo-info-label">'+g+'</span><span class="wgo-info-value">'+a[g]+"</span></div>";return f+"</div>"},l=b.extendClass(b.BasicPlayer.component.Component,function(a){this["super"](a);this.player=a;this.element.className="wgo-commentbox";this.box=document.createElement("div");
...
widgets:[{constructor:f.Button,args:{name:"about",click:function(a){a.showMessage(b.t("about-text"))}}}]}},{constructor:f.Group,args:{name:"control",widgets:[{constructor:f.Button,args:{name:"first",disabled:!0,init:function(b){b.addEventListener("update",m.bind(this));b.addEventListener("frozen",l.bind(this));b.addEventListener("unfrozen",a.bind(this))},click:function(a){a.first()}}},{constructor:f.Button,args:{name:"multiprev",disabled:!0,multiple:!0,init:function(b){b.addEventListener("update",
m.bind(this));b.addEventListener("frozen",l.bind(this));b.addEventListener("unfrozen",a.bind(this))},click:function(a){var c=b.clone(a.kifuReader.path);c.m-=10;a.goTo(c)}}},{constructor:f.Button,args:{name:"previous",disabled:!0,multiple:!0,init:function(b){b.addEventListener("update",m.bind(this));b.addEventListener("frozen",l.bind(this));b.addEventListener("unfrozen",a.bind(this))},click:function(a){a.previous()}}},{constructor:f.MoveNumber},{constructor:f.Button,args:{name:"next",disabled:!0,multiple:!0,
...
disabled:!0,init:function(b){b.addEventListener("update",d.bind(this));b.addEventListener("frozen",l.bind(this));b.addEventListener("unfrozen",a.bind(this))},click:function(a){a.last()}}}]}}];var k=b.BasicPlayer.layouts;k.right_top.top.push("Control");k.right.right.push("Control");k.one_column.top.push("Control");k.no_comment.bottom.push("Control");k.minimal.bottom.push("Control");var k={about:"About",first:"First",multiprev:"10 moves back",previous:"Previous",next:"Next",multinext:"10 moves forward",
last:"Last","switch-coo":"Display coordinates",menu:"Menu"},n;for(n in k)b.i18n.en[n]=k[n];b.BasicPlayer.component.Control=g})(WGo);(function(b){var p=function(b,g){this.player.frozen||this._lastX==b&&this._lastY==g||(this._lastX=b,this._lastY=g,this._last_mark&&this.board.removeObject(this._last_mark),-1!=b&&-1!=g&&this.player.kifuReader.game.isValid(b,g)?(this._last_mark={type:"outline",x:b,y:g,c:this.player.kifuReader.game.turn},this.board.addObject(this._last_mark)):delete this._last_mark)},g=function(){this._last_mark&&(this.board.removeObject(this._last_mark),delete this._last_mark,delete this._lastX,delete this._lastY)};
...
p.bind(this),this._ev_out=this._ev_out||g.bind(this),this.board.addEventListener("click",this._ev_click),this.board.addEventListener("mousemove",this._ev_move),this.board.addEventListener("mouseout",this._ev_out),this.editMode=!0;else if(this.editMode&&!f){this.originalReader.goTo(this.player.kifuReader.path);f=this.originalReader;for(var m=this.player.kifuReader.getPosition(),d=this.originalReader.getPosition(),l=m.size,a=[],h=[],k=0;k<l*l;k++)m.schema[k]&&!d.schema[k]?h.push({x:Math.floor(k/l),
y:k%l}):m.schema[k]!=d.schema[k]&&a.push({x:Math.floor(k/l),y:k%l,c:d.schema[k]});f.change={add:a,remove:h};this.player.kifuReader=this.originalReader;this.player.update(!0);this.board.removeEventListener("click",this._ev_click);this.board.removeEventListener("mousemove",this._ev_move);this.board.removeEventListener("mouseout",this._ev_out);this.editMode=!1}};b.Player.Editable.prototype.play=function(f,g){!this.player.frozen&&this.player.kifuReader.game.isValid(f,g)&&(this.player.kifuReader.node.appendChild(new b.KNode({move:{x:f,
...
function(b){(g._disabled=g.disabled)||g.disable()});b.addEventListener("unfrozen",function(b){g._disabled||g.enable();delete g._disabled})}}});b.i18n.en.editmode="Edit mode"})(WGo);(function(b){var p=function(b,g,a,f){this.originalPosition=b;this.position=b.clone();this.board=g;this.komi=a;this.output=f},g=p.state={UNKNOWN:0,BLACK_STONE:1,WHITE_STONE:-1,BLACK_CANDIDATE:2,WHITE_CANDIDATE:-2,BLACK_NEUTRAL:3,WHITE_NEUTRAL:-3,NEUTRAL:4},f=function(b,g,a,h,k){var n=b.get(g,a);void 0!==n&&n!=h&&n!=k&&(b.set(g,a,h),f(b,g-1,a,h,k),f(b,g,a-1,h,k),f(b,g+1,a,h,k),f(b,g,a+1,h,k))},m=function(b,g,a,f,k){var n=g.get(a,f);b.get(a,f)!=n&&(b.set(a,f,n),m(b,g,a-1,f,k),m(b,g,a,f-1,k),m(b,g,a+
1,f,k),m(b,g,a,f+1,k))};p.prototype.start=function(){this.calculate();this.saved_state=this.board.getState();this.displayScore();this._click=function(d,l){var a=this.originalPosition.get(d,l);a==b.W?this.position.get(d,l)==g.WHITE_STONE?f(this.position,d,l,g.BLACK_CANDIDATE,g.BLACK_STONE):(m(this.position,this.originalPosition,d,l,g.BLACK_STONE),this.calculate()):a==b.B?this.position.get(d,l)==g.BLACK_STONE?f(this.position,d,l,g.WHITE_CANDIDATE,g.WHITE_STONE):(m(this.position,this.originalPosition,
...
this.board.removeEventListener("click",this._click)};p.prototype.displayScore=function(){for(var d=[],f=[],a=[],h=[],k=[],n=0;n<this.position.size;n++)for(var e=0;e<this.position.size;e++)s=this.position.get(n,e),t=this.originalPosition.get(n,e),s==g.BLACK_CANDIDATE?d.push({x:n,y:e,type:"mini",c:b.B}):s==g.WHITE_CANDIDATE?f.push({x:n,y:e,type:"mini",c:b.W}):s==g.NEUTRAL&&a.push({x:n,y:e}),t==b.W&&s!=g.WHITE_STONE?k.push({x:n,y:e,type:"outline",c:b.W}):t==b.B&&s!=g.BLACK_STONE&&h.push({x:n,y:e,type:"outline",
c:b.B});for(n=0;n<h.length;n++)this.board.removeObjectsAt(h[n].x,h[n].y);for(n=0;n<k.length;n++)this.board.removeObjectsAt(k[n].x,k[n].y);this.board.addObject(k);this.board.addObject(h);this.board.addObject(d);this.board.addObject(f);a="<p style='font-weight: bold;'>"+b.t("RE")+"</p>";n=d.length+k.length+this.originalPosition.capCount.black;e=f.length+h.length+this.originalPosition.capCount.white+parseFloat(this.komi);a+="<p>"+b.t("black")+": "+d.length+" + "+(k.length+this.originalPosition.capCount.black)+
" = "+n+"</br>";a+=b.t("white")+": "+f.length+" + "+(h.length+this.originalPosition.capCount.white)+" + "+this.komi+" = "+e+"</p>";a=n>e?a+("<p style='font-weight: bold;'>"+b.t("bwin",n-e)+"</p>"):a+("<p style='font-weight: bold;'>"+b.t("wwin",e-n)+"</p>");this.output(a)};p.prototype.calculate=function(){var b,f,a,h,k,n;b=this.position;for(n=!0;n;){n=!1;for(var e=0;e<b.size;e++)for(var c=0;c<b.size;c++)if(f=b.get(c,e),f==g.UNKNOWN||f==g.BLACK_CANDIDATE||f==g.WHITE_CANDIDATE){a=[b.get(c-1,e),b.get(c,
e-1),b.get(c+1,e),b.get(c,e+1)];k=h=!1;for(var m=0;4>m;m++)a[m]==g.BLACK_STONE||a[m]==g.BLACK_CANDIDATE?h=!0:a[m]==g.WHITE_STONE||a[m]==g.WHITE_CANDIDATE?k=!0:a[m]==g.NEUTRAL&&(k=h=!0);a=!1;h&&k?a=g.NEUTRAL:h?a=g.BLACK_CANDIDATE:k&&(a=g.WHITE_CANDIDATE);a&&f!=a&&(n=!0,b.set(c,e,a))}}};b.ScoreMode=p;b.BasicPlayer&&b.BasicPlayer.component.Control&&b.BasicPlayer.component.Control.menu.push({constructor:b.BasicPlayer.control.MenuItem,args:{name:"scoremode",togglable:!0,click:function(d){if(this.selected)return d.setFrozen(!1),
this._score_mode.end(),delete this._score_mode,d.notification(),d.help(),!1;d.setFrozen(!0);d.help("<p>"+b.t("help_score")+"</p>");this._score_mode=new b.ScoreMode(d.kifuReader.game.position,d.board,d.kifu.info.KM||.5,d.notification);this._score_mode.start();return!0}}});b.i18n.en.scoremode="Count score";b.i18n.en.score="Score";b.i18n.en.bwin="Black wins by $ points.";b.i18n.en.wwin="White wins by $ points.";b.i18n.en.help_score="Click on stones to mark them dead or alive. You can also set and unset territory points by clicking on them. Territories must be completely bordered."})(WGo);(function(b,p){var g={active:!0,query:{}},f=function(b){try{g.query=JSON.parse('{"'+window.location.hash.substr(1).replace("=",'":')+"}")}catch(f){g.query={}}};window.addEventListener("hashchange",function(){if(""!=window.location.hash&&g.active){f();for(var b in g.query){var l=document.getElementById(b);l&&l._wgo_player&&l._wgo_player.goTo(m)}}});window.addEventListener("DOMContentLoaded",function(){""!=window.location.hash&&g.active&&f()});window.addEventListener("load",function(){if(""!=window.location.hash&&
g.active)for(var b in g.query){var f=document.getElementById(b);if(f&&f._wgo_player){f.scrollIntoView();break}}});var m=function(){if(g.query[this.element.id])return g.query[this.element.id]["goto"]};b.Player["default"].move=m;b.BasicPlayer&&b.BasicPlayer.component.Control&&b.BasicPlayer.component.Control.menu.push({constructor:b.BasicPlayer.control.MenuItem,args:{name:"permalink",click:function(d){var f=location.href.split("#")[0]+"#"+d.element.id+'={"goto":'+JSON.stringify(d.kifuReader.path)+"}";
d.showMessage("<h1>"+b.t("permalink")+'</h1><p><input class="wgo-permalink" type="text" value=\''+f+'\' onclick="this.select(); event.stopPropagation()"/></p>')}}});b.Player.permalink=g;b.i18n.en.permalink="Permanent link"})(WGo);
